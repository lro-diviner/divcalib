...
def create_plot_pointings(
    azim_start=-60, azim_min=-80, azim_max=-40, elev_start=30, elev_min=-10
):
    # azimuths
...
def plot3d_animation(df_in):
    ...
    view_ani = animation.FuncAnimation(
        fig, update_pointing, pointings, interval=100, repeat_delay=2000
    )
